...
(idx, num,inPass );
if(delete_ok) {
String url = "main.jsp?pagefile=read&num="+num+"&nowPage=" + nowPage;
...
<body>
	<div align="center">
		...
		<form name="delFrm" method="post" action="delete_reply.jsp">
			...
			<input type="hidden" name="idx" value="<%=idx%>"> <input type="hidden" name="num" value="<%=num%>">
		</form>
	</div>
	<%
	}
