...
<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse" id="#bs-example-navbar-collapse-1">
			...
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="list2.jsp">게시판</a></li>
...
<table style="align: center; width: 960;">		
 ...
 %> <!-- 페이징 및 블럭 처리 End-->
				...
				<td align="right">
				<button type="submit" class="btn btn-primary" Onclick="window.location='post.jsp'">글쓰기</button>
				
				<a href="javascript:list()" class="btn btn-default">처음으로</a>
